        ...
        return (
            <div className='file-plate' onClick={() => openDirHandler(file)}>
                ...
                <div className="file-plate__btns">
                    {file.type !== 'dir' &&
                    <button onClick={(e) => downloadClickHandler(e)} className="file-plate__btn file-plate__download"><img src={downloadBtn} alt="Скачать"/></button>}
                    <button onClick={(e) => deleteClickHandler(e)} className="file-plate__btn file-plate__delete"><img src={deleteBtn} alt="Удалить"/></button>
                </div>
            </div>
        );
    }
